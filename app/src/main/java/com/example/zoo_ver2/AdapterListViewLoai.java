...
public class AdapterListViewLoai extends BaseAdapter {
    ...
    public AdapterListViewLoai(Context context, ArrayList<Lion> lion, ArrayList<Elephant> elephant, ArrayList<Tiger> tiger, ArrayList<Wolf> wolf, ArrayList<Snake> snake, int layout) {
