...
//        }
        ...
        if (bundle != null) {
            ...
            zoo.add(elephant);
        //them cua viet
//        Intent intent2 = new Intent(DongVat.this, ThongTinChiTiet.class);
//        Bundle bundle2 = new Bundle();
//        bundle2.putStringArrayList("arraylion");
        ...
        if (bundle1 != null) {
            ...
            AdapterListViewLoai adapterListView = new AdapterListViewLoai(this, lion, elephant, tiger, wolf, snake, R.layout.loai);
            ...
            dsLoai.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int pos, long id) {
                    ...
                    if (pos == 0){
                        ...
                        loaiCanHienThi = "tiger";
                    }
                    else if (pos == 2) {
                        loaiCanHienThi = "wolf";
                    }
                    else if (pos == 3) {
                        loaiCanHienThi = "snake";
                    }
                    else if (pos == 4) {
                        loaiCanHienThi = "elephant";
                    }
